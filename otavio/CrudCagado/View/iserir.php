...
<body class='container'>
  <form method="get" action="../Controller/corrigido.php?Acao=<?= $_GET['acao'] ?> ">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control" name='item' id="lastName" placeholder="" value='<?=$nomeItem ?>' required>
    </div>
    <div class="col-sm-6">
      <label for="lastName" class="form-label">Preço do Item</label>
      <input type="text" class="form-control" id="lastName" name='preco' placeholder="" value='<?=$preco ?>' required>
    </div>
    <div class="col-sm-6">
      <label for="lastName" class="form-label">Quantidade</label>
      <input type="text" class="form-control" id="lastName" placeholder="" name='quant' value='<?=$qtd ?>' required>
      <div>
